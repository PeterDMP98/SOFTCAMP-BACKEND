...
export const getEmpleados = async (req, res) => {
  try {
    ...
    return res.json({ message: "Empleados obtenidos correctamente", data: empleados });
  } catch (error) {
...
export const getEmpleadoById = async (req, res) => {
  try {
    ...
    return res.json({ message: "Empleado obtenido correctamente", data: empleado });
  } catch (error) {
...
export const createEmpleado = async (req, res) => {
  try {
    ...
    return res.status(201).json({ message: "Empleado creado correctamente", data: nuevo });
  } catch (error) {
...
export const updateEmpleado = async (req, res) => {
  try {
    ...
    return res.json({ message: "Empleado actualizado correctamente", data: actualizado });
  } catch (error) {
