...
export const stockCreateSchema = z.object({
  id_producto: z.number().int().positive("Producto inválido"),
  unidad_de_medida: z.string().max(40).optional().nullable(),
  tipo_paquete: z.string().max(50).optional().nullable(),
  cantidad_en_paquetes: z.number().min(0).optional().default(0),
  cantidad_stock: z.number().int().min(0).optional().default(0),
